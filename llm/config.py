...
FINETUNED_ADAPTER_PATH: str = os.getenv("FINETUNED_ADAPTER_PATH", "")
...
try:
    ...
    print(f"\n[CrimeVision-QA] WARNING — MongoDB connection FAILED: {exc}")
    print(f"  URI: {MONGODB_URI[:30]}...")
    print("  Server will start, but database queries will fail at runtime.")
...
if FINETUNED_ADAPTER_PATH:
    print(f"  FineTuned:  {FINETUNED_ADAPTER_PATH}")
print()
